package com.chuwa.exercise.collection.hw4.Features.optional;
...
//        assertThrows(NoSuchElementException.class, optional::orElseThrow);
    ...
    private void assertThrows(Class<NoSuchElementException> noSuchElementExceptionClass, Object orElseThrow) {
    }
