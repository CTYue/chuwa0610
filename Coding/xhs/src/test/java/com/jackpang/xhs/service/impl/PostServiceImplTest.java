...
//        postService.deleteById(1L);
        Optional<Post> byId = postRepositoryMock.findById(1L);
        postRepositoryMock.delete(byId.get());
        // verify
    ...
    public void testDeletePostById_ResourceNotFoundException() {
        ...
        // execute and assertions
        Assertions.assertThrows(ResourceNotFoundException.class, () -> postService.deleteById(1L));
    }
