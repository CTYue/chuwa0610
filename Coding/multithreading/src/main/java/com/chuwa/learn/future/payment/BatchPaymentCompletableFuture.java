...
import static com.chuwa.learn.future.payment.OrderProcessUtil.queryOrder;
import static com.chuwa.learn.future.payment.OrderProcessUtil.sendEmail;
...
//            CompletableFuture<Void> future = orderFuture.thenApplyAsync(OrderProcessUtil::makePayment, executorService).thenAcceptAsync(paymentResult -> sendEmail(orderFuture.join(), paymentResult), executorService);
