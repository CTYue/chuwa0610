package com.chuwa.learn.multithread.hw5.c08_future.batch_payments;
...
import static com.chuwa.learn.multithread.hw5.c08_future.batch_payments.OrderProcessUtil.*;
...
public class BatchPaymentCompletableFuture {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        List<String> orderIds = Arrays.asList("order1", "order2", "order3"); // 假设这里是并发查询
