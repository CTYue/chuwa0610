...
public class CompletableFutureApiLearn {
   ...
   public void demo02() {
      ...
      /**
       * CompletableFuture.supplyAsync() 方法返回一个 CompletableFuture<U> 对象，其中的 U 类型是
       * Supplier 对象的返回类型；
      ...
      CompletableFuture<Void> cf2 = CompletableFuture
            .runAsync(() -> System.out.println(Thread.currentThread() + ": Hello2"));
   ...
   /**
    * The thenAccept method receives a Consumer(no return) and passes it the result
    * of the computation
    */
   @Test
   public void demo04() {
   ...
   /**
    * If we neither need the value of the computation, nor want to return some
    * value at the
    ...
    * The thenApply and the thenCompose methods closely relate to the map and
    * flatMap methods of Stream
    */
   @Test
   public void demo06() {
   ...
   /**
    * Using the thenCombine method to execute two independent Futures and do
    * something
   ...
   /**
    * CompletableFuture.allOf static method allows waiting for completion of all
    * the Futures
    */
   @Test
   public void demo09() {
    ...
    * throws an unchecked
    * exception. This makes it possible to use it as a method reference in the
    * Stream.map()
    */
   @Test
   public void demo10() {
