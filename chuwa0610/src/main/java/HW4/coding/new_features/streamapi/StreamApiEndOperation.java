...
import HW4.coding.new_features.lambda.Employee;
import HW4.coding.new_features.lambda.EmpolyeeData;
...
public class StreamApiEndOperation {
    ...
    private static final List<Employee> EMPLOYEES = EmpolyeeData.getEmployees();
